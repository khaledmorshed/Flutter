         ...
         // alignment: Alignment.center,
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.end,
              children: [Padding(padding: EdgeInsets.all(8.0), child: ElevatedButton(
                onPressed: (){}, child: Padding(padding: EdgeInsets.all(8.0), child: Text("Button1"),
              )
              ),
              ),
             Padding(padding: EdgeInsets.all(8.0), child: ElevatedButton(
                onPressed: (){}
              , child: Padding(padding: EdgeInsets.all(100.0), child: Text("Button2"),
              )
              ),
              ),
